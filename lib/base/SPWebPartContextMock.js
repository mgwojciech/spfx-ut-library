...
const AadTokenProviderFactoryMock_1 = require("../http/tokens/AadTokenProviderFactoryMock");
...
class SPWebPartContextMock {
    constructor() {
        ...
        this.aadTokenProviderFactory = new AadTokenProviderFactoryMock_1.AadTokenProviderFactoryMock();
